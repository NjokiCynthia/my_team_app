...
class IntroScreenState extends State<IntroScreen> {
  ...
  _isFirstTime() async {
    (await getPreference("isFirstTime") != '') ? Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (BuildContext context) => ChamasoftDashboard(),),).whenComplete((){ _loading = false; }) : setState(() { _loading = false; });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return _loading ? _pageLoading() : IntroductionScreen(
      key: introKey,
      pages: [
        PageViewModel(
          title: "A fix for your Chama",
          body: "A leading book keeping tool for investment groups that handles all your Chama's financial administration as you focus on your investments.",
          image: _buildImage('onboarding_1'),
          decoration: _pageDeco(pageColor: Colors.blue[900],),
        ),
        PageViewModel(
          title: "...merry-go-rounds too",
          body: "Send your contributions, manage members, make withdrawals straight to your M-Pesa, and more. It's never been this easy.",
          image: _buildImage('onboarding_2'),
          decoration: _pageDeco(pageColor: Colors.blue[800],),
        ),
        PageViewModel(
          title: "...or even a fundraiser!",
          body: "Running a fundraiser & in need of a solution for processing contributions? Give your contributors a great experience & hit your target faster.",
