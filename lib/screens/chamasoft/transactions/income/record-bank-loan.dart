    ...
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              toolTip(context: context,title: "Manually record loans received from financial institutions",message: "",),
              Padding(
                        ...
                        children: <Widget>[
                          Expanded(
                            ...
                            child:DatePicker(
                              ...
                              selectedDate: loanFromDate == null ? new DateTime(now.year, now.month, now.day - 1, 6, 30) : loanFromDate,
                          ...
                          Expanded(
                            ...
                            child: DatePicker(
                              labelText: 'Loan To',
                              firstDate: loanFromDate == null ? new DateTime(now.year, now.month, now.day - 1, 6, 30) : loanFromDate,
                              lastDate: DateTime(2037),
                              selectedDate: loanToDate == null ? new DateTime(now.year, now.month, now.day - 1, 6, 30) : loanToDate,
                              selectDate: (selectedDate) {
                                setState(() {
