...
class _LoanTypeFinesState extends State<LoanTypeFines> {
  ...
  void _getFineDetails() {
    if (widget.isEditMode) {
      ...
      enableLateLoanRepaymentFines = (int.tryParse(settings['enable_loan_fines'].toString()) ?? 0) == 1 ? true : false;
      lateLoanPaymentFineTypeId = parseZeroDropdownValues(settings, "loan_fine_type");
      ...
      oneOffPercentageOnId = parseZeroDropdownValues(settings, "one_off_percentage_rate_on");
      fixedFineAmount = settings['fixed_fine_amount'].toString();
      fixedFineFrequencyId = parseZeroDropdownValues(settings, "fixed_amount_fine_frequency");
      fixedFineAmountFrequencyOnId = parseZeroDropdownValues(settings, "fixed_amount_fine_frequency_on");
      percentageFineRate = settings['percentage_fine_rate'].toString();
      percentageFineFrequencyId = parseZeroDropdownValues(settings, "percentage_fine_frequency");
      percentageFineOnId = parseZeroDropdownValues(settings, "percentage_fine_on");

      enableFinesForOutstandingBalances =
          (int.tryParse(settings['enable_outstanding_loan_balance_fines'].toString()) ?? 0) == 1 ? true : false;
      outstandingBalanceFineTypeId = parseZeroDropdownValues(settings, "outstanding_loan_balance_fine_type");
      outstandingLoanBalanceOneOffFineAmount = settings['outstanding_loan_balance_fine_one_off_amount'].toString();
      outstandingLoanBalanceFixedFineAmount = settings['outstanding_loan_balance_fine_fixed_amount'].toString();
      outstandingLoanBalanceFixedFineFrequencyId =
          parseZeroDropdownValues(settings, "outstanding_loan_balance_fixed_fine_frequency");
      outstandingLoanBalancePercentageFineRate = settings['outstanding_loan_balance_percentage_fine_rate'].toString();
      outstandingLoanBalancePercentageFineFrequencyId =
          parseZeroDropdownValues(settings, "outstanding_loan_balance_percentage_fine_frequency");
      outstandingLoanBalancePercentageFineChargedOnId =
          parseZeroDropdownValues(settings, "outstanding_loan_balance_percentage_fine_on");
    } else
  ...
  void _submit(BuildContext context) async {
    ...
    formData["enable_outstanding_loan_balance_fines"] = enableFinesForOutstandingBalances ? 1 : 0;
    formData["outstanding_loan_balance_fine_type"] = outstandingBalanceFineTypeId;
    formData["outstanding_loan_balance_fine_fixed_amount"] = outstandingLoanBalanceFixedFineAmount;
    formData["outstanding_loan_balance_fixed_fine_frequency"] = outstandingLoanBalanceFixedFineFrequencyId;
    formData["outstanding_loan_balance_percentage_fine_rate"] = outstandingLoanBalancePercentageFineRate;
    formData["outstanding_loan_balance_percentage_fine_frequency"] = outstandingLoanBalancePercentageFineFrequencyId;
    formData["outstanding_loan_balance_percentage_fine_on"] = outstandingLoanBalancePercentageFineChargedOnId;
    formData["outstanding_loan_balance_fine_one_off_amount"] = outstandingLoanBalanceOneOffFineAmount;

    print("$formData");
    try {
      final response = await Provider.of<Groups>(context, listen: false).addLoanTypeStepTwo(formData);
      print(response);
      requestId = null;
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, mainAxisSize: MainAxisSize.min, children: <Widget>[
                    ...
                    child: Column(
                      children: <Widget>[
                        CustomDropDownButton(
                            ...
                            validator: (value) {
                              if (enableLateLoanRepaymentFines) if (value == null) {
                        ...
                        Visibility(
                          ...
                          child: CustomDropDownButton(
                              ...
                              validator: (value) {
                                if (enableLateLoanRepaymentFines && lateLoanPaymentFineTypeId == 3) if (value == null) {
                                  return "This field is required";
                                }
                                return null;
                              }),
                        ...
                        Visibility(
                          ...
                          child: numberDecimalFieldWithInitialValue(
                            ...
                            validator: (value) {
                              if (enableLateLoanRepaymentFines && oneOffFineTypeId == 1) {
                        ...
                        Visibility(
                          ...
                          child: numberDecimalFieldWithInitialValue(
                            ...
                            validator: (value) {
                              if (enableLateLoanRepaymentFines && oneOffFineTypeId == 2) {
                                if (value.trim() == '' || value.trim() == null) {
                                  return 'This field is required';
                                }
                              }
                        ...
                        Visibility(
                          ...
                          child: CustomDropDownButton(
                              ...
                              validator: (value) {
                                if (enableLateLoanRepaymentFines && oneOffFineTypeId == 2) if (value == null) {
                                  return "This field is required";
                                }
                                return null;
                              }),
                        ...
                        Visibility(
                          ...
                          child: numberDecimalFieldWithInitialValue(
                            ...
                            validator: (value) {
                              if (enableLateLoanRepaymentFines && lateLoanPaymentFineTypeId == 1) {
                                if (value.trim() == '' || value.trim() == null) {
                                  return 'This field is required';
                                }
                              }
                        ...
                        Visibility(
                          ...
                          child: CustomDropDownButton(
                              ...
                              validator: (value) {
                                if (enableLateLoanRepaymentFines && lateLoanPaymentFineTypeId == 1) if (value == null) {
                                  return "This field is required";
                                }
                                return null;
                              }),
                        ...
                        Visibility(
                          ...
                          child: numberDecimalFieldWithInitialValue(
                            ...
                            validator: (value) {
                              if (enableLateLoanRepaymentFines && lateLoanPaymentFineTypeId == 2) {
                                if (value.trim() == '' || value.trim() == null) {
                                  return 'This field is required';
                                }
                              }
                        ...
                        Visibility(
                          ...
                          child: CustomDropDownButton(
                              ...
                              validator: (value) {
                                if (enableLateLoanRepaymentFines && lateLoanPaymentFineTypeId == 2) if (value == null) {
                                  return "This field is required";
                                }
                                return null;
                              }),
                  ...
                  Visibility(
                    ...
                    child: Column(children: <Widget>[
                      CustomDropDownButton(
                          ...
                          validator: (value) {
                            if (enableFinesForOutstandingBalances) if (value == null) {
                              return "This field is required";
                            }
                            return null;
                          }),
                      Visibility(
                        ...
                        child: numberDecimalFieldWithInitialValue(
                            ...
                            isFormEnabled: _isFormEnabled,
                            onChanged: (value) {
                              outstandingLoanBalanceOneOffFineAmount = value;
                            },
                            validator: (value) {
                              if (enableFinesForOutstandingBalances &&
                                  outstandingBalanceFineTypeId == 3) if (value.trim() == '' || value.trim() == null) {
                                return "This field is required";
                              }
                              return null;
                            }),
                      ...
                      Visibility(
                        ...
                        child: numberDecimalFieldWithInitialValue(
                            ...
                            validator: (value) {
                              if (enableFinesForOutstandingBalances && outstandingBalanceFineTypeId == 1) {
                                if (value.trim() == '' || value.trim() == null) {
                                  return 'This field is required';
                                }
                              }
                      ...
                      Visibility(
                        ...
                        child: CustomDropDownButton(
                            ...
                            validator: (value) {
                              if (enableFinesForOutstandingBalances && outstandingBalanceFineTypeId == 1) if (value ==
                                  null) {
                                return "This field is required";
                              }
                              return null;
                      ...
                      Visibility(
                        ...
                        child: numberDecimalFieldWithInitialValue(
                          ...
                          onChanged: (value) {
                            outstandingLoanBalancePercentageFineRate = value;
                          },
                          validator: (value) {
                            if (enableFinesForOutstandingBalances && outstandingBalanceFineTypeId == 2) {
                              if (value.trim() == '' || value.trim() == null) {
                                return 'This field is required';
                              }
                            }
                      ...
                      Visibility(
                        ...
                        child: CustomDropDownButton(
                            ...
                            validator: (value) {
                              if (enableFinesForOutstandingBalances && outstandingBalanceFineTypeId == 2) if (value ==
                                  null) {
                                return "This field is required";
                              }
                              return null;
        ...
        _isLoading
            ...
            : Column(
                children: [
                  defaultButton(context: context, text: "Save & Continue", onPressed: () => _submit(context)),
                ],
              ),
        SizedBox(
          height: 10,
