...
class AccounBalancesReciept extends StatefulWidget {
  ...
  const AccounBalancesReciept({Key key, this.data, this.totalBalance})
      : super(key: key);

  @override
  State<AccounBalancesReciept> createState() => _AccounBalancesRecieptState();
}

class _AccounBalancesRecieptState extends State<AccounBalancesReciept> {
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                customTitleWithWrap(
                                  text:
                                      'Balance: ${groupObject.groupCurrency} ${currencyFormat.format(widget.data.balance)}',
                                  fontSize: 18,
                        ...
                        onTap: () async {
                          await Share.share(
                              "Confirmed. Your account balance was: " +
                                  ...
                                  " " +
                                  currencyFormat.format(widget.data.balance) +
                                  " " +
                                  "on " +
                                  formatter +
                                  " at " +
